...
export function DashboardLayout(){
  ...
  return <div className="min-h-screen bg-slate-50">
    <header className="fixed inset-x-0 top-0 z-20 flex h-16 items-center border-b border-slate-200 bg-white px-4 shadow-sm lg:hidden">
    ...
    <aside className={`fixed inset-y-0 left-0 z-30 w-72 bg-inha-950 p-6 text-white transition-transform lg:translate-x-0 ${open?'translate-x-0':'-translate-x-full'}`}>
    ...
    <main className="min-h-screen p-5 pt-24 lg:ml-72 lg:p-10"><div className="mx-auto max-w-[1600px]"><Outlet/></div></main>
  </div>
}
