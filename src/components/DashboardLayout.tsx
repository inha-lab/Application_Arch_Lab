import { Bell, BookOpen, ClipboardCheck, ClipboardList, Cpu, FolderKanban, History, LayoutDashboard, LogOut, Menu, PackageCheck, ShieldCheck, Users, X } from 'lucide-react'
...
const menus={
  professor:[['','대시보드',LayoutDashboard],['participants','수강생 관리',Users],['activity-logs','로그인 활동',History],['admin-users','관리자 관리',ShieldCheck],['teams','팀 관리',FolderKanban],['projects','프로젝트 현황',BookOpen],['reports','주간(일)보고',ClipboardList],['artifacts','산출물 관리',PackageCheck],['gpu-reservations','GPU 예약',Cpu],['evaluation','실시간 평가',ClipboardCheck],['/announcements','공지사항',Bell]],
  ...
  researcher:[['','대시보드',LayoutDashboard],['participants','수강생 관리',Users],['activity-logs','로그인 활동',History],['admin-users','관리자 관리',ShieldCheck],['teams','팀 관리',FolderKanban],['projects','프로젝트 현황',BookOpen],['reports','주간(일)보고',ClipboardList],['artifacts','산출물 관리',PackageCheck],['gpu-reservations','GPU 예약',Cpu],['evaluation','실시간 평가',ClipboardCheck],['/announcements','공지사항',Bell]],
} as const
